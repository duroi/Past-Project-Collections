...
3.Histogram Stretching: histostretchcv
Histogram stretching on image.
parameter: no

4.Histogram Equalization: histoequalcv
Histogram equalization on image.
parameter: no

5.Hough Transformation:houghtrans
Performes Hough Circle Transformation on image.
parameter: no

6.Histogram Equalization + Sobel: hesobel
Performs equalization and Sobel edge detection.
parameter: no

7.Histogram Equalziation + Canny: hecanny
Performs equalization and Canny edge detection.
parameter: no

8.Canny: cannycv
Peforms Canny edge detection on image.
parameter: no

9. Sobel: sobelcv
Peforms Sobel edge detection on image.
parameter: no

10. Sobel Difference: hesobeldiff
Subtracts an image using Sobel detection with and without equalziation
parameter: no

11. Canny Difference: hecannydiff
Subtracts an image using Canny detection with and without equalziation
parameter: no
...
*Currently only use of 1 ROI for OpenCV functions is working*
